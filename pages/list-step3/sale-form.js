    ...
    <div>
      <div className="form-container">
        ...
        <div className="row">
          <div className="col-md-5">
            <div className="form-group">
              ...
              <input
                ...
                name="price"
                id="price"
                placeholder="Enter Price (Min 50 Lacs)"
                className="form-control "
              ...
              {props.simpleValidator && (
                <div className="form-error">
                  {props.simpleValidator.current.message(
                    "Price",
                    getValue(props.request, "price", 0),
                    "required"
                  )}
                </div>
              )}
          ...
          {/* <div className="col-md-5">
						<div className="form-group">
							...
							<input
								...
								name="property_rera"
								id="property_rera"
								placeholder="Enter Property RERA"
								className="form-control "
								value={getValue(props, `request.property_rera`, "")}
								onChange={props.onChange}
							/>
						</div>
					</div> */}
          ...
          {/* <div className="col-md-5">
						<div className="form-group">
							...
							<input
								...
								className="form-control "
								value={getValue(props, `request.total_units`, "")}
								onChange={props.onChange}
							/>
						</div>
					</div>
					...
					<div className="col-md-5">
						<div className="form-group">
							...
							<input
								...
								id="development_size"
								placeholder="Enter Development Size"
								className="form-control "
								value={getValue(props, `request.development_size`, "")}
								onChange={props.onChange}
							/>
						</div>
					</div> */}
          ...
          {getValue(props, "property_type", "") !== "Apartments" && (
            <div className="col-md-5">
              <div className="form-group">
          ...
          <div className="col-md-5">
            <div className="form-group">
              ...
              <input
                ...
                id="super_build_up_area"
                placeholder="Enter Built-up Area (Sqft)"
                className="form-control "
                value={getValue(props, `request.super_build_up_area`, "")}
                onChange={props.onChange}
              />
              {props.simpleValidator && (
                <div className="form-error">
                  {props.simpleValidator.current.message(
                    "Built-up Area",
                    getValue(props.request, "super_build_up_area", ""),
                    "required"
                  )}
                </div>
              )}
        ...
        <div className="row">
          {/* <div className="col-md-5">
					...
					<div className="col-md-5">
						<div className="form-group">
							...
							<input
								type="number"
								name="super_build_up_area_min"
								id="super_build_up_area_min"
								placeholder="Enter Build Up Area Min (sqft)"
								className="form-control "
								value={getValue(props, `request.super_build_up_area_min`, "")}
								onChange={props.onChange}
							/>
						</div>
					</div>
					<div className="col-md-5">
						<div className="form-group">
							...
							<input
								type="number"
								name="super_build_up_area_max"
								id="super_build_up_area_max"
								placeholder="Enter Build Up Area Max (sqft)"
								className="form-control "
								value={getValue(props, `request.super_build_up_area_max`, "")}
								onChange={props.onChange}
							/>
						</div>
					</div>
          ...
          <div className="col-md-10">
            <div className="form-group">
              <label htmlFor="video" className="label-contact">
                Property Video Link (Youtube)
              </label>
              <textarea
                name="video_url"
                id="video_url"
                rows="7"
                placeholder="Enter Property Video Link (Youtube)"
                className="form-control textarea"
                value={getValue(props, `request.video_url`, "")}
                onChange={props.onChange}
              />
            </div>
          </div>
